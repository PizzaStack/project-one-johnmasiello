...
@WebServlet(urlPatterns = "/validate-manager")
public class ValidateManagerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (model != null) {
			if (new ManagerDao().authenticateLogin(model.getUsername(), model.getPassword()) != null) {
